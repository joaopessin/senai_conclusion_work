        ...
        <div class="row">
            <div class="col-md-6 retangulo-horizontal">
                <div class="op-logins">
                    ...
                    <a href="index.php"><img class="logo-tela-log" src="img/obra360.png" alt="Logo do Obra360" width="100" height="100"></a>
            ...
            <div class="col-md-6 retangulo-vertical">
                ...
                <div class="login-box">
                    ...
                    <form action="./bd/validarLogin_cliente.php/conexao.php" method="post">
                        <div class="user-box">
